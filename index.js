...
const nameBand = 'CARL DOUGLAS';

let nameSongs = [
	"KUNG FU FIGHTING", /*1*/
	"CHANGING TIMES", /*2*/
	"I WANT TO GIVE YOU MY EVERYTHING", /*3*/
	"DANCE THE KUNG FU", /*4*/
	"SHANGHAI'D", /*5*/
	"TOO HOT TO HANDLE", /*6*/
	"SERVING A SENTENCE OF LIFE", /*7*/
	"RUN BACK", /*8*/
	"WITCHFINDER GENERAL", /*9*/
	"WHEN YOU GOT LOVE", /*10*/
	"CHANGING TIMES", /*11*/
	"DANCE THE KUNG FU", /*12*/
	"NEVER HAD THIS DREAM BEFORE", /*13*/
	"I DON'T CARE WHAT PEOPLE SAY", /*14*/
	"GAMBLIN' MAN", /*15*/
	"M.O.R.F.", /*16*/
	"GREEN TANGERINES AND WILD EVERGREENS", /*17*/
	"STAND UP FOR LOVE", /*18*/
	"MISTAKES OF MINE", /*19*/
	"LOVE PEACE AND HAPPINESS", /*20*/
]
